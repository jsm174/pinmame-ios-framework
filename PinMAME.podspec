Pod::Spec.new do |s|
  ...
  s.description  = "A complete description of MyFramework"
  s.author       = "jsm174@gmail.com"
  s.platform     = :ios, "13.0"
  s.homepage     = "http:/gEXAMPLE/MyFramework"
  s.library      = 'z'
  
  s.xcconfig     = { 
     'GCC_C_LANGUAGE_STANDARD' => 'gnu99',
     'GCC_NO_COMMON_BLOCKS' => 'NO',
     'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) PINMAME=1 MAMEVER=7300 LSB_FIRST=1 PINMAME_FRAMEWORK=1',
     'USER_HEADER_SEARCH_PATHS' => '"${PODS_TARGET_SRCROOT}/src"/**' 
  }
  ...
  s.subspec 'framework' do |ss|
    ss.source_files = 'src/framework/fileio.c', 
                      'src/framework/keyboard.c', 
                      'src/framework/keyboard.h',
                      'src/framework/devices.c', 
                      'src/framework/pinmame_framework.c', 
                      'src/framework/pinmame_framework.h', 
                      'src/framework/alias.c', 
                      'src/framework/alias.h', 
                      'src/framework/config.h', 
                      'src/framework/config.c', 
                      'src/framework/osd_cpu.h', 
                      'src/framework/osinline.h', 
                      'src/framework/sound.h', 
                      'src/framework/sound.c', 
                      'src/framework/ticker.c', 
                      'src/framework/video.c', 
                      'src/framework/sysdep/rc.h',
                      'src/framework/sysdep/rc.c',
                      'src/framework/sysdep/misc.h',
                      'src/framework/sysdep/misc.c',
                      'src/framework/fronthlp.c'
    ss.public_header_files = 'src/framework/pinmame_framework.h'
  end
end
